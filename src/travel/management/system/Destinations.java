...
public class Destinations extends JFrame implements Runnable {
    ...
    public void run(){
        ...
        String[] text=new String[]{"JW Marriott","EBA", "Snowfall res.","oriental hotel","four season hotel","hotel diya","hotel diva", "rock and fall","rast and room","plat fall rooms"};
