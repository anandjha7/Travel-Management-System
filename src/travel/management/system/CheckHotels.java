...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run(){
        ...
        String[] text=new String[]{"JW Marriott","EBA", "Snowfall res.","oriental hotel","four season hotel","hotel diya","hotel diva", "rock and fall","rest and room","plat fall rooms"};
